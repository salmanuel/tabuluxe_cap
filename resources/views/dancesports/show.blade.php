...
<div class="mt-2">
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            ...
            <button type="button" class="btn btn-secondary" data-toggle="popover" title="This contest has a {{$contest->computation}} computation method and belongs to the dancesport {{$contest->title}}." data-content="Popover content"><i class="fa-solid fa-circle-info"></i></button>
        </div>
        <div class="d-flex justify-content-end">
            <a href="{{url('/dancesports')  }}" class="btn btn-warning">Back </a>
        </div>
    </div>
    <hr>
</div>
    ...
    <div class="col-md-5 mb-3">
        <div class="card h-100">
            <div class="card-body shadow">
                <div class="float-end">
                    @include('dancesports._add-round')
                </div>
                <h5>Rounds</h5>
                <hr>
